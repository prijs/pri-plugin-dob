...
function (_React$Component) {
  ...
  (0, _createClass2.default)(View, [{
    ...
    value: function render() {
      return React.createElement(S.Container, null, "Stores Info: TODO");
    }
  }]);
  return View;
}(React.Component);
...
exports.default = {
  ...
  view: View,
  init: function init(applicationAction) {
    applicationAction.event.on("freshProjectStatus", function () {
      var dobInfo = applicationAction.applicationStore.status.analyseInfo.projectAnalyseDob;

      if (dobInfo) {
        applicationAction.pipeTreeNode(function (treeData) {
          treeData[0].children.push({
            key: "stores",
            title: "Stores (".concat(dobInfo.storeFiles.length, ")"),
            icon: React.createElement(TreeIcon, {
              type: "database"
            }),
            disabled: dobInfo.storeFiles.length === 0,
            children: dobInfo.storeFiles.map(function (storeFile, index) {
              return {
                key: index,
